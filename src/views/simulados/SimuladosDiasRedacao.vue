  ...
  <ion-page>
    <ion-content>
      <div class="ion-padding fundo-cima">
        <h4 class="ion-margin-vertical text-white">Simulados Estaduais</h4>
      </div>
      ...
      <ion-list class="ion-padding rounded-top">
        ...
        >
          ...
          <p class="mt-0 text-black">
            No card abaixo você poderá acessar o Simulado do
            <b>{{ simulado.dia }}º dia</b>. Você terá 4 horas para terminá-lo
            após o inicio do simulado.
          </p>

          <ion-item class="ion-margin-top rounded" lines="none">
            <div class="flex flex-column text-black">
              <ion-text color="primary">
                <h3 class="mb-4 font-bold text-lg">Simulado estadual</h3>
              </ion-text>
              ...
              <article class="mt-8">
                <ion-text>
                  <p class="ion-no-margin">
                    Disponível entre:
                    <ion-text color="verde" class="font-bold">{{
                      simulado.inicio
                    }}</ion-text>
                    e
                    <ion-text color="vermelho" class="font-bold">{{
                      simulado.fim
                    }}</ion-text>
                  </p>
                  ...
                  <p class="mb-0 mt-8">
                    ...
                    <ion-text color="primary" class="font-bold"
                      >{{ simulado.tempo }} minutos restantes</ion-text
                    >
                  </p>
              ...
              <div
                class="mt-16 flex flex-column text-black"
                v-if="simulado.dia === 1"
              >
                <ion-text color="primary">
                  <h3 class="mb-4 font-bold text-lg">Redação</h3>
                </ion-text>

                <p class="mt-0 text-black">
                  Você terá da data inicio até a data fim do simulado para fazer
                  e enviar a sua redação tenha calma na hora de realizar que
                  tudo vai da certo!
                </p>

                <ion-text color="primary">
                  <h3 class="mb-4 font-bold text-lg">Redação estadual</h3>
                </ion-text>
...
.fundo-cima {
  background: url("../../../public/assets/images/simulado-estadual-fundo.png")
    var(--ion-color-primary) no-repeat right center/50%;
}
.text-black {
  color: black;
}
